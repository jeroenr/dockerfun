...
CATALINA_HOME=${tomcatFolder}
JAVA_OPTS="-Xmx512M -XX:MaxPermSize=256M -Dunite.environment=${unite.environment} -Djava.security.auth.login.config=$CATALINA_HOME/conf/jaas.config -noverify -javaagent:/Users/bas/Library/jrebel/jrebel.jar -Xdebug -Xrunjdwp:transport=dt_socket,server=y,address=8000,suspend=n"
