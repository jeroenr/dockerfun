...
set "CATALINA_HOME=$tomcatFolder"
set "JAVA_OPTS=-Xmx512M -XX:MaxPermSize=256M -Dunite.environment=$uniteEnvironment -Djava.security.auth.login.config=%CATALINA_HOME%/conf/jaas.config"
